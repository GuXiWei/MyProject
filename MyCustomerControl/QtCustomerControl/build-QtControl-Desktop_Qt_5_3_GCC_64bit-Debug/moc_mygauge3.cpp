...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myGauge3_t, stringdata) + ofs \
...
const QMetaObject myGauge3::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_myGauge3.data,
      qt_meta_data_myGauge3,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myGauge3.stringdata))
