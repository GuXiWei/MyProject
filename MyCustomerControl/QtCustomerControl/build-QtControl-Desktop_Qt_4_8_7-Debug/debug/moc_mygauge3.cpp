...
static const char qt_meta_stringdata_myGauge3[] = {
    "myGauge3\0\0value\0valueChanged(qreal)\0"
    "ShowTip()\0HideTip()\0min,max\0"
    "setRange(int,int)\0setValue(qreal)\0"
};
...
const QMetaObjectExtraData myGauge3::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject myGauge3::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_myGauge3,
      qt_meta_data_myGauge3, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &myGauge3::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myGauge3))
