...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myGauge2_t, stringdata) + ofs \
...
const QMetaObject myGauge2::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_myGauge2.data,
      qt_meta_data_myGauge2,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myGauge2.stringdata))
